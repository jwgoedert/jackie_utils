...
async function createProjectDirectories() {
  try {
    ...
    try {
      // Create the parent 'project_folders' directory first
      console.log('Creating parent project_folders directory...');
      const parentFolderId = await createStrapiFolder('project_folders');
      ...
      for (const projectName of projects) {
        ...
        try {
          ...
          // Create/update main project folder under project_folders
          const mainFolderId = await createStrapiFolder(projectName, parentFolderId);
